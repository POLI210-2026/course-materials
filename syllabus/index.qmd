...
Assigned political science articles, data, and short supplementary readings will be posted on CatCourses or linked in the weekly materials.
...
The schedule may be adjusted to match the pace of the class. Changes will be announced in class and on CatCourses. Chapter references are to Speegle and Clair, *Probability, Statistics, and Data* (PSD). The official semester dates are available in the [UC Merced 2026-27 Academic Calendar](https://registrar.ucmerced.edu/schedules/academic-calendar/academic-calendar-2026-2027).
...
| **Sep. 16** | Conditional probability, independence, and Bayes' rule. **PSD Ch. 2.** | A2 due; assign B1 |
